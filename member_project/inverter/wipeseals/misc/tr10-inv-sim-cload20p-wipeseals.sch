...
N -310 160 -310 190 {lab=GND}
N -380 160 -380 190 {lab=GND}
N -380 80 -380 100 {lab=VDD}
...
C {devices/vdd.sym} -380 80 0 0 {name=l3 lab=VDD}
C {devices/code.sym} -260 -230 0 0 {name=TR10_MODELS
only_toplevel=true
format="tcleval( @value )"
value=".include $::LIB/../ip62_models"
spice_ignore=false}
C {devices/vsource.sym} -380 130 0 0 {name=Vdd value=5 savecurrent=false}
C {devices/gnd.sym} -380 190 0 0 {name=l4 lab=GND}
C {devices/gnd.sym} -310 190 0 0 {name=l5 lab=GND}
...
C {devices/lab_pin.sym} -310 80 2 0 {name=p1 sig_type=std_logic lab=vin}
C {devices/lab_pin.sym} -30 80 2 0 {name=p3 sig_type=std_logic lab=vin}
C {IP62LIB/MP.sym} 60 0 0 0 {name=XM1 model=PMOS w=82.5u l=10u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
C {IP62LIB/MN.sym} 60 160 0 0 {name=XM3 model=NMOS w=34u l=10u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
C {devices/code_shown.sym} 350 150 0 0 {name=measure only_toplevel=false value="
...
C {devices/code_shown.sym} 330 -130 0 0 {name=spice only_toplevel=false value=".option savecurrent
.control
save all
...
.endc
"}
C {devices/vsource.sym} -310 130 0 0 {name=vin value="pwl 0 0 10n 0 20n 5.0 60n 5.0 70n 0" savecurrent=false}
