...
C {IP62LIB/MP.sym} 200 -250 0 0 {name=XM6 model=PMOS w=540u l=2u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
C {IP62LIB/MN.sym} 200 -110 0 0 {name=XM7 model=NMOS w=180u l=2u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
